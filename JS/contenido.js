function nuevoParrafo() {
  ...
  function nuevoEnlace() {
    ...
    var textoEnlace = prompt("Ingrese el texto que se mostrará para el enlace:");
    if(url && textoEnlace){
      var contenido = document.getElementById('contenido');
      contenido.innerHTML += '<a href="' + url + '" target="_blank">' + textoEnlace + '</a><br>';
    } else {
      alert("Se canceló la creación del enlace o faltaron datos.");
    }
  }
